...
<div className="pb-5 pt-5 font-poppins pl-4 font-semibold  text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-pink-400 to-red-600"> <p>Seogbtools.dev</p></div>
