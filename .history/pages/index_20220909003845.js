 ...
 <div class="flex items-center space-x-4">
  ...
  <div class="mt-3 font-xl dark:text-white text-md  font-semibold font-inter	">
    ...
    />
            ...
            <li>
              <a class=" flex items-center px-4 py-2  text-gray-400 rounded-base hover:bg-stone-900    bg-stone-900   hover:text-gray-100 active:bg-stone-900  " href="#">
              <img
    ...
    />
            ...
            <li>
              <a class="flex items-center px-4 py-2  text-gray-400 rounded-base hover:bg-zinc-800 bg-neutral-900	      hover:text-gray-100 active:bg-neutral-900  " href="#">
              <img
    ...
    />
            ...
            <li>
              <a class="flex items-center px-4 py-2  text-gray-400 rounded-md hover:bg-zinc-800 bg-neutral-900	      hover:text-gray-100 active:bg-neutral-900  " href="#">
              <img
