...
Message
    ...
    {/* Sidebar Begins  */}
              ...
              <section class="h-[38.5vw]   shadow-md shadow-neutral-600 ml-10 mr-10  rounded-b-lg bg-black	   overflow-y-auto " > 
...
<p class="mr-4 ml-4 text-xs text-gray-400   px-5 py-10 font-inter bg-blend-lighten md:bg-blend-darken border-2 border-zinc-800 rounded-lg m-auto leading-4 flex flex-col-2 ">
