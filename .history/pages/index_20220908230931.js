export default function Home() {
  return (
    ...
    <div class="h-1 w-fit bg-black "></div>
          ...
          <img src="/compsi.png"  />
<div>
<p className="text-base  font-poppins tracking-tighter  font-semibold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-[#a220ff]  to-pink-500">Seogbtools.dev</p>
