...
<p className="text-gray-500 text-xs pl-10">You'll be up & running in 2 minutes
  ...
  <div className="   justify-center items-center relative w-full position-center ml-10 mr-10  ">
   ...
   <p className="   font-inter text-sm font-semibold   text-gray-200 hover:underline hover:cursor-pointer hover:text-gray-400 "><Link href="/login.js"><a> Already Have an Account? Login in
