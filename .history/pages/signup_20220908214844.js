...
<div>
  <p className="text-lg  font-poppins tracking-tight font-medium	 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-[#a220ff]  to-pink-500">Seogbtools.dev</p>
