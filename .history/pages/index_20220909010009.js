...
<button type="button" class="text-gray-900 border-gray-500 border-2   ring-slate-400 ring-offset-zinc-800  border-1 bg-black  focus:ring-2 focus:outline-none focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-blue-500 mr-2 mb-2 ml-5 font-inter ">
Message
</button>
