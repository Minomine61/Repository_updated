export default function Home() {
  return (
    ...
    <div class="h-1 w-fit bg-black "></div>
          ...
          <div class="  ml-4 flex items-center  mx-auto justify-center pt-8 space-x-1">
<img src="/compsi.png" className="h-10 w-30 " />
<div>
...
Message
    ...
    {/* Sidebar Begins  */}
              ...
              <section class="flex h-[38.5vw]   shadow-md shadow-neutral-600 ml-10 mr-10  rounded-lg bg-black	   overflow-y-auto " > 
  <div class=" flex flex-col w-[17vw] bg-black  h-full shadow-xl  bg-opacity-100    border-r-2 border-zinc-600	" arial-label="Sidebar">
 ...
 <div class="flex items-center space-x-4">
  ...
  <div class="mt-3 font-xl dark:text-white text-md  font-semibold font-inter	">
     ...
     <div className="text-left text-ellipsis font-inter"></div>
          ...
          <ul>
            <li>
              <a class=" flex items-center px-4 py-2 text-gray-400 rounded-md hover:bg-zinc-900  bg-zinc-900		    hover:text-gray-100 active:bg-zinc-900   " href="#">
              <img
...
<p class="mr-4 ml-4 text-base text-gray-400  px-5 py-10 font-poppins bg-blend-lighten md:bg-blend-darken border-2 border-zinc-800 rounded-lg m-auto mt-10 leading-4">
<span class="bg-[#7c3aed]  text-gray-100  mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 font-inter text-base">BETA</span>
