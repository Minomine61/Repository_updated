...
<div className="pb-5 pt-5 font-poppins pl-4 font-semibold  text-5xl  text-transparent bg-clip-text bg-gradient-to-r from-cyan-500   via-lime-100 to-[#bbdcfa]"> <p>Seogbtools.dev</p></div>
