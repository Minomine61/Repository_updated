...
<div className="pb-5 pt-5 text-lg bg-transparent	tracking-tight  font-semibold font-poppins text-transparent bg-clip-text bg-gradient-to-r from-[#ffc83a] via-[#ff008a] to-[#6100ff]"> <p>Seogbtools.dev</p></div>
