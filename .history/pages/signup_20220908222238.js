...
export default function Login() {
    ...
    return (
      ...
      <div className="container font-inter h-screen  relative w-full  bg-gradient-to-r from-[#f5edff]  via-lime-100 to-[#bbdcfa] flex flex-col-2 " >
<div className="flex- flex-col bg-black  border-zinc-800  shadow-2xl  border-b-2 rounded-2xl w-[96rem">

<h1> Welcome to Seogbtools.dev</h1>
<p>On the other hand, you should not use JWTs as session tokens by default. For one thing, JWT has a wide range of features and a large scope, which increases the potential for mistakes, either by library authors or users.</p>
