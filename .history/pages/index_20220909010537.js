export default function Home() {
  return (
    <div div class="container font-inter h-screen  relative w-full  bg-gradient-to-r from-[#f5edff]  via-lime-100 to-[#bbdcfa]  ">
...
<button type="button" class="text-gray-200 border-gray-500 border-2   ring-slate-400 ring-offset-zinc-800  border-1 bg-black  focus:ring-2 focus:outline-none focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-blue-500 mr-2 mb-2 ml-5 font-inter ">
Message
</button>
    ...
    {/* Sidebar Begins  */}
              ...
              <section class="flex grid grid-col-2 h-[38.5vw]   shadow-md shadow-neutral-600 ml-10 mr-10  rounded-b-lg bg-black	   overflow-y-auto " > 
 ...
 <div class="flex items-center space-x-4">
  ...
  <div class="mt-3 font-xl dark:text-white text-md  font-semibold font-inter	">
     ...
     <div className="text-left text-ellipsis font-inter"></div>
          ...
          <ul>
            <li>
              <a class=" flex items-center px-4 py-2 mr-2 ml-2 text-gray-400 rounded-base  bg-neutral-900		    hover:text-gray-100 active:bg-stone-900   " href="#">
              <img
    ...
    />
            ...
            <li>
            <a class=" flex items-center px-4 py-2 mr-2 ml-2 text-gray-400 rounded-base  	    hover:text-gray-100 active:bg-stone-900   " href="#">
              <img
...
<p class="mr-4 ml-4 text-xs text-gray-400   px-5 py-10 font-inter bg-blend-lighten md:bg-blend-darken border-2 border-zinc-800 rounded-lg m-auto leading-4">
<span class="bg-[#818cf8]  text-gray-100  mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 font-inter text-base ">BETA</span><br></br>
...
<div class="block pt-6 pr-1 pl-1 rounded-lg bg-black border-2 border-zinc-800 shadow-md shadow-gray-900 ">
 ...
 <img src="/Ahref.webp" class="w-20 h-20 rounded-2xl shadow-xl shadow-lime-[80]  "alt=""/>     
  ...
  <p class="text-gray-400 text-sm mt-5 font-inter mb-2 ml-4 leading-5 font-medium">
...
{/* Section end from here */}
         ...
         <div className="  box-content sticky top-0 bg-blue-600 p-5 drop-shadow shadow-blue-600  h-10   border-zinc-800  shadow-2xl  border-b-2  flex flex-wrap  items-center justify-between  mt-8  ">
