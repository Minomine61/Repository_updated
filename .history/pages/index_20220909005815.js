...
<button type="button" class="text-gray-900   ring-slate-400  border-1 bg-blue-500  focus:ring-2 focus:outline-none focus:ring-blue-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-blue-500 mr-2 mb-2 ml-5 font-inter ">
Message
</button>
