...
<div>
  ...
  <h1 className="text-white text-lg mx-auto px-auto pl-12 pr-5 font-semibold pt-4">Sign in to your account
</h1>
<p className="text-gray-500 text-xs pl-12 mb-2">You'll be up & running in 2 minutes


</p>
  <div class=" w-fit bg-black "></div>
  ...
  <div className="   justify-center items-center relative w-full position-center ml-10 mr-10  ">
    ...
    <button type="submit" class="text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-2 font-inter focus:outline-none focus:ring-gray-200  font-medium rounded-md text-sm  sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-700 mb-4">Login</button>
