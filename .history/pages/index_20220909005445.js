...
<div className="  box-content  h-10 bg-white  border-zinc-800  shadow-2xl shadow-gra border-b-2 rounded-b-2xl flex flex-wrap  items-center justify-between  mt-8  ">
