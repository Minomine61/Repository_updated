...
<div className="pb-5 pt-5 font-poppins pl-4 font-semibold  text-5xl  text-transparent bg-clip-text bg-gradient-to-tb from-cyan-500   via-violet-500  to-pink-500"> <p>Seogbtools.dev</p></div>
