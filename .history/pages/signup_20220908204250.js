...
export default function Login() {
  ...
  <h1 className="text-white text-2xl mx-auto px-auto pl-5 pr-5 font-semibold">Create your Account
</h1>
  ...
  <div className="   justify-center items-center relative w-full position-center ml-10 mr-10  ">
    ...
    <div class="flex items-start mb-4">
      <div class="flex items-center h-5">
         <p className=" font-inter text-xs float-right text-gray-200  hover:bg-zinc-900 hover:text-gray-400 hover:cursor-pointer"><a> <u>Forgot Password</u></a></p>
      </div>
