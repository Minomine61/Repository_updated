...
<div>
  ...
  <h1 className="text-white text-lg mx-auto px-auto pl-10 pr-5 font-semibold pt-4">Sign in to your account
</h1>
<p className="text-gray-500 text-xs pl-10 mb-2">You'll be up & running in 2 minutes
