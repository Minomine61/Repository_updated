...
<p class="mr-4 ml-4 text-xs text-gray-400  px-5 py-10 font-inter bg-blend-lighten md:bg-blend-darken border-2 border-zinc-800 rounded-lg m-auto mt-10 leading-4 pt-3">
<span class="bg-[#7c3aed]  text-gray-100  mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 font-inter text-base">BETA</span><br></br>
