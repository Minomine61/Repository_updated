...
{/* Section end from here */}
  ...
  <div className="  box-content   bg-black  border-zinc-800  shadow-2xl shadow-gra border-b-2 rounded-t-2xl flex flex-wrap  items-center justify-between ml-10 mr-10 mt-8  ">
