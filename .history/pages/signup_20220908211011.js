...
<p className="text-gray-500 text-xs pl-10">You'll be up & running in 2 minutes
  ...
  <div className="   justify-center items-center relative w-full position-center ml-10 mr-10  ">
    <button type="submit" class="text-white mb-3 bg-gray-800 hover:bg-blue-800 focus:ring-2 font-inter focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><div className="  box-content flex flex-wrap  items-center space-x-1"><img className="h-[15px] w-[20px] ml-3" src="/google.svg"/><p>Continue with Google</p> </div></button>
